...
const NoEthereum = () => {
  return (
    ...
    <p className="p-not-found">FUT requires an Ethereum client to be running and current. FUT could not detect a client running which probably means it's not installed,
    ...
    <div className="div-clients">
      <div className="div-metamask">
        ...
        <p><span className="align-number"><span className="numberCircle">2</span></span>Use Chrome to browse <a className="span-montserrat-semi-bold a-link" href="#" target="_blank">#</a></p>
      </div>
      <div className="div-mist">
        ...
        <p><span className="align-number"><span className="numberCircle">2</span></span>Use Mist to browse <a className="span-montserrat-semi-bold a-link" href="#" target="_blank">#</a></p>
      </div>
    </div>
    <p className="p-connect-geth">While you can also connect with <b>geth</b> or <b>parity</b>, a more advanced configuration is needed. See the
      <a href="#" target="_blank">FUT documentation</a> for instructions.
    </p>
  </div>
  )
};
